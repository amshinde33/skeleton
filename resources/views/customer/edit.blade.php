								...
								<div class="wizard-step" data-wizard-type="step" data-wizard-state="current">
									<div class="wizard-wrapper">
										...
										<div class="wizard-label">
											<h3 class="wizard-title">Customer Profile</h3>
						...
						<div class="wizard-body py-8 px-8 py-lg-20 px-lg-10">
							...
							@if (count($errors) > 0)
								...
								<div class="offset-xxl-2 col-xxl-8">
									...
									<form class="form" action="http://localhost/skeleton/public/customerUpdate/{{$customers->id}}" id="kt_form" method="POST">
										<!--begin: Wizardp Step 1-->
										@csrf
										<div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
											<h4 class="mb-10 font-weight-bold text-dark">Enter your Customer Details</h4>
											...
											<div class="row">
												<div class="col-xl-6">
													...
													<div class="form-group">
														...
														<input type="text" class="form-control form-control-solid form-control-lg" name="fname" placeholder="First Name" value="<?php echo $customers->fname; ?>" />
												...
												<div class="col-xl-6">
													<div class="form-group">
														...
														<input type="text" class="form-control form-control-solid form-control-lg" name="lname" placeholder="Last Name" value="<?php echo $customers->lname; ?>" />
											...
											<div class="row">
												<div class="col-xl-6">
													...
													<div class="form-group">
														...
														<input type="tel" class="form-control form-control-solid form-control-lg" name="personalphoneno" placeholder="Personal Phone Number" value="<?php echo $customers->personalphoneno; ?>" />
												...
												<div class="col-xl-6">
													...
													<div class="form-group">
														...
														<input type="tel" class="form-control form-control-solid form-control-lg" name="workphoneno" placeholder="Work Phone Number" value="<?php echo $customers->workphoneno; ?>" />
											...
											<div class="row">
												<div class="col-xl-6">
													...
													<div class="form-group">
														...
														<?php  { $selectedvalue = $customers->country;} ?>
												...
												<div class="col-xl-6">
													...
													<div class="form-group">
														...
														<input type="text" class="form-control form-control-solid form-control-lg" name="orgnization" placeholder="Orgnization Name" value="<?php echo $customers->orgnization; ?>" />
											...
											<div class="row">
												<div class="col-xl-6">
													...
													<div class="form-group">
														<label>Website</label>
														<input type="text" class="form-control form-control-solid form-control-lg" name="website" placeholder="Website" value="<?php echo $customers->website; ?>" />
												...
												<div class="col-xl-6">
													...
													<div class="form-group">
														...
														<input type="file" class="form-control form-control-solid form-control-lg" name="file" placeholder="Upload File here" value="<?php echo $customers->file; ?>" />
														<span class="form-text text-muted">Please enter your orgnization name.</span>
													</div>
													<!--end::Input-->
												</div>
											...
											<div class="row">
												<div class="col-xl-6">
													...
													<div class="form-group">
														...
														<textarea name="aboutme" id="" cols="10" rows="4" class="form-control form-control-solid form-control-lg" value="<?php echo $customers->aboutme; ?>"><?php echo $customers->aboutme; ?></textarea>
										...
										<div class="pb-5" data-wizard-type="step-content">
											...
											<div class="row">
												<div class="col-xl-6">
													...
													<div class="form-group">
														...
														<input type="text" class="form-control form-control-solid form-control-lg" name="facebook" placeholder="Facebook" value="<?php echo $customers->facebook; ?>" />
												...
												<div class="col-xl-6">
													...
													<div class="form-group">
														...
														<input type="text" class="form-control form-control-solid form-control-lg" name="linkedin" placeholder="LinkedIn" value="<?php echo $customers->linkedin; ?>" />
											...
											<div class="row">
												<div class="col-xl-6">
													...
													<div class="form-group">
														<label>Twitter</label>
														<input type="text" class="form-control form-control-solid form-control-lg" name="twitter" placeholder="Twitter" value="<?php echo $customers->twitter; ?>" />
												...
												<div class="col-xl-6">
													...
													<div class="form-group">
														<label>GitHub</label>
														<input type="text" class="form-control form-control-solid form-control-lg" name="github" placeholder="GitHub" value="<?php echo $customers->github; ?>" />
										...
										<div class="d-flex justify-content-between border-top mt-5 pt-10">
											...
											<div>
												<button type="Submit" class="btn btn-success font-weight-bold text-uppercase px-9 py-4" name="" data-wizard-type="action-submit">Update</button>
