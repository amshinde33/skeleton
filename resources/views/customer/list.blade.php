            ...
            <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                ...
                <?php  $i=1;?>
                    ...
                    <tr>
                        ...
                        <td>{{ $customer->personalphoneno}}</td>
                        <td>{{ $customer->workphoneno}}</td>
                        <td>{{ $customer->country}}</td>
                        <td>{{ $customer->orgnization}}</td>
                        <td>{{ $customer->website}}</td>
                        <td>{{ $customer->file}}</td>
                        <td>{{ $customer->aboutme}}</td>
                        <td>{{ $customer->facebook}}</td>
                        <td>{{ $customer->linkedin}}</td>
                        <td>{{ $customer->twitter}}</td>
                        <td>{{ $customer->github}}</td>
                        <td>
                            <a class="btn btn-primary" title="Edit" href="customerEdit/{{ $customer->id}} "><i class="fa fa-edit"></i></a>
                            <a class="btn btn-primary scrap_status" href="" data-id="<?php echo $customer->id; ?>" title="Status" data-toggle="modal" data-target="#statusModal"><i class="fa fa-user-slash"></i></a>
                        </td>
 ...
 <div class="modal fade" id="statusModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form role="form" method='POST' action="customerStatus " enctype="multipart/form-data" class="col-xs- col-sm-12 col-md-12 col-lg-">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Status of Customer</h5>
