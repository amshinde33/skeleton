...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            ...
            <div class="card-toolbar">
                ...
                <!--end::Dropdown-->
                <!--begin::Button-->
                <a href="{{url('addUserPage')}}" class="btn btn-light-primary font-weight-bolder">
                    <span class="svg-icon svg-icon-md">
            ...
            <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $user->fname}}</td>
                        <td>{{ $user->lname}}</td>
                        <td>{{ $user->personalphoneno}}</td>
                        <td>{{ $user->workphoneno}}</td>
                        <td>{{ $user->country}}</td>
                        <td>{{ $user->orgnization}}</td>
                        <td>{{ $user->website}}</td>
                        <td>{{ $user->file}}</td>
                        <td>{{ $user->aboutme}}</td>
                        <td>{{ $user->facebook}}</td>
                        ...
                        <td>{{ $user->github}}</td>
                        <td>
                            <!-- <a class="btn btn-primary" title="Edit" href="delete/<?php echo $user->id ?>"><i class="fa fa-edit"></i></a> -->
                            <a class="btn btn-primary scrap" data-toggle="modal" data-target="#deleteModal" data-id="<?php echo $user->id; ?>" title="Delete"><i class="fa fa-trash"></i></a>
                            <a class="btn btn-primary scrap_status" href="" data-id="<?php echo $user->id; ?>" title="status" data-toggle="modal" data-target="#statusModal"><i class="fa fa-user-slash"></i></a>
                        </td>
    ...
    <div class="modal fade" id="deleteModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form role="form" method='post' action="delete/<?php echo $user->id; ?> " enctype="multipart/form-data" class="col-xs- col-sm-12 col-md-12 col-lg-">
                    @csrf
    ...
    <div class="modal fade" id="statusModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form role="form" method='POST' action="status/<?php echo $user->id; ?> " enctype="multipart/form-data" class="col-xs- col-sm-12 col-md-12 col-lg-">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Status of user</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <i aria-hidden="true" class="ki ki-close"></i>
                        </button>
                    </div>
